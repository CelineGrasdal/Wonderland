...
public class Actions extends Game {
	...
	public Actions() {
		...
		Collections.addAll(nounVerb, "n", "s", "e", "w", "north", "south", "east", "west", "northeast", "northwest", "southeast", "southwest", "ne", "nw", "se", "sw", "q", "quit", "san", "sanity", "i", "inventory", "sit", "stand", "drink");
